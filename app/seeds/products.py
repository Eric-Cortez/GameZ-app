...
def seed_products():
    ...
    rpg_game_2 = Product(
        user_id=1, category_id=1,  name='Valheim', image_url='https://dotesports.com/wp-content/uploads/2021/02/19120418/valheim-1.jpg?w=1200', price=19.99, description="""
